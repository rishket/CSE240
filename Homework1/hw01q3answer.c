...
int main(){
   ...
   printf("y is %d\n",y); 
	...
	printf("Error Type: Semantic \n\n");
     ...
     printf("Semantic Error because the program was meant to print the integer y, but read it as a char instead, so the program was unable to understand the objective. \n\n");
	// Problem 4: (2 points)
